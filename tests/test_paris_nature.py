...
def test_paris_nature():
    ...
    assert len(nature_pois) > 0, "Aucun POI nature trouvé dans paris_pois.json"
    ...
    # Export JSON
    builder.export_itinerary_to_json(days_itinerary, "paris_nature_test.json")

    builder.close()

    print("\nItinéraire Paris Nature généré avec succès.")
