...
def test_limoux_nature():
    ...
    assert len(nature_pois) > 0, "Aucun POI nature trouvé dans limoux_pois.json"
    ...
    # Export JSON
    builder.export_itinerary_to_json(days_itinerary, "limoux_nature_test.json")

    builder.close()

    print("\nItinéraire Limoux Nature généré avec succès.")
